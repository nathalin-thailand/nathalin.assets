    ...
    var _componentValidation = function() {
        ...
        $.validator.addMethod('filesize', function (value, element, param) {
            ...
            for (var i = 0; i != element.files.length; i++) {
                sumSize += element.files[i].size;
            }

            return this.optional(element) || (sumSize <= (param*1000000))
        }, 'Total size of files must be less than {0} MB');
        ...
        var validator = $('.form-validate-jquery').validate({
            ...
            rules: {
                ...
                "files[]": {
                    extension: "docx|rtf|doc|pdf|png|jpg|jpeg|xls|csv|xlsx|gif|bmp|ppt|pptx|txt",
                    filesize: 5
                },
                "AssignmentFiles[]": {
                    extension: "docx|rtf|doc|pdf|png|jpg|jpeg|xls|csv|xlsx|gif|bmp|ppt|pptx|txt",
